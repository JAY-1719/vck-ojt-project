            ...
            <div className="main-wrapper"> {/* Uses shared class */}
                <div className="main-box"> {/* Uses shared class */}
                    ...
                    <div className="hero-section">
                        <img alt="Vivekanand College Campus"className="hero-banner-image" src="/images/vck.jpeg" />
                    ...
                    {/* Uses shared class */}
                        ...
                        <div className="campus-images-container">
                            <img src="../images/vck3.jpeg" alt="Vivekanand College Information" className="campus-image"/>
                            <img src="../images/vck2.jpeg" alt="Vivekanand College campus " className="campus-image"/>
                              <div className="call-to-action">
                                  <a class="primary-btn" href="/About" data-discover="true">Explore About</a>
                              </div>
                        </div>
                    </div>
                </div>
